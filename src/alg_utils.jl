...
alg_order(alg::ImprovedEuler) = 1 // 1
...
alg_interpretation(alg::ImprovedEuler{interpretation}) where {interpretation} = interpretation
...
alg_compatible(prob::DiffEqBase.AbstractSDEProblem, alg::ImprovedEuler) = true
